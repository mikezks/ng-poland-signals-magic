...
function createComputed(computation) {
    ...
    // MOD
    console.log({COMPUTED_SIGNAL: computed})
    return computed;
}
/**
...
function createSignal(initialValue) {
    ...
    getter[SIGNAL] = node;
    // MOD
    console.log({WRITABLE_SIGNAL: getter})
    return getter;
}
...
function createWatch(fn, schedule, allowSignalWrites) {
    ...
    const run = () => {
        // MOD
        console.log('WATCH_EFFECT_RUN', node);
        if (node.fn === null) {
...
const WATCH_NODE = /* @__PURE__ */ (() => {
    return {
        ...
        consumerMarkedDirty: (node) => {
          // MOD
          console.log('WATCH_EFFECT_DIRTY', node);
